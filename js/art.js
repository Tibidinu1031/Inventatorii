...
(function (global) {
  ...
  I.abur = function () { return s('M20 50 C10 40 30 36 20 26 C12 18 26 12 22 6', 'rgba(190,215,230,.9)', 6) + s('M40 52 C30 42 50 38 40 28 C32 20 46 14 42 8', 'rgba(190,215,230,.7)', 6); };
  ...
  I.vant = function () { return s('M6 20 H38 A7 7 0 1 0 32 12', P.metal2, 5) + s('M6 34 H46 A7 7 0 1 1 40 44', P.metal2, 5) + s('M10 48 H30', P.metal2, 5); };
  ...
  SC.spatiu = function () {
    ...
    for (i = 0; i < 46; i++) { x = (i * 97) % 396; y = (i * 53) % 232; b += c(x + 2, y + 2, (i % 3) ? 1.4 : 2.4, i % 4 ? '#ffffff' : '#ffe27a'); }
  ...
  SC.noapte = function () {
    ...
    for (i = 0; i < 30; i++) b += c((i * 131) % 392 + 4, (i * 61) % 150 + 6, i % 3 ? 1.3 : 2.2, '#ffffff');
  ...
  global.ART = {
    ...
    icon: icon, label: label, character: character, scene: scene, svgWrap: svgWrap,
